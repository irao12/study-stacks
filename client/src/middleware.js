...
const publicRoutes = ["/login", "/", "/signup", "/viewcards", "/createcards"];
...
export async function middleware(request) {
	...
	if (
		...
		request.nextUrl.pathname == "/viewcards" ||
		request.nextUrl.pathname == "/createcards"
	)
...
export const config = {
	matcher: ["/", "/login", "/signup", '/((?!login/api|signup/api|api|_next/static|_next/image|favicon.ico).*)', '/viewcards', '/createcards'],
};
